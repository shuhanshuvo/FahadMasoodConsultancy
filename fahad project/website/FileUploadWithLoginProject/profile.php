   ...
   ?>
     <div class="panel panel-default">
        <div class="panel-heading">
          <h3>Profile Details <span class="pull-right"><a class="btn btn-primary" href="index.php">Back</a></span></h3>
        </div>
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="company">Company</label>
                          <input type="text" class="form-control" placeholder="Enter company Name" name="company" id="company" value="<?php echo $userdata->company ?>">
                      </div>
